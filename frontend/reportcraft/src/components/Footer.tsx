      ...
      <div className="mx-auto max-w-[1200px] px-5 md:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1fr_auto_auto]">
          ...
          <div className="max-w-xs">
            ...
            <p
              className="mt-4 type-callout leading-relaxed"
              style={{ color: "var(--text-secondary)" }}
            >
              AI-generated research reports grounded in live web sources.
              Every claim cited, every source clickable.
            </p>
            {/* GitHub — systemBlue on hover */}
            <a
              href="https://github.com/shriya7756/ReportCraft"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 inline-flex items-center gap-2 type-callout font-medium transition-colors"
              style={{ color: "var(--text-tertiary)" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--sys-blue)")}
          ...
          {Object.entries(FOOTER_LINKS).map(([group, links]) => (
            <div key={group}>
              <p
                className="type-caption2 font-semibold uppercase tracking-wider mb-4"
              ...
              <ul className="space-y-2.5 list-none m-0 p-0">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="type-callout transition-colors"
                      style={{ color: "var(--text-secondary)" }}
                      onMouseEnter={(e) => (e.currentTarget.style.color = "var(--sys-blue)")}
        ...
        <div
          ...
          style={{ borderColor: "var(--border)" }}
        >
          <p className="type-footnote" style={{ color: "var(--text-tertiary)" }}>
            &copy; {currentYear} ReportCraft. Powered by{" "}
            <a
              href="https://cohere.com"
              target="_blank"
              rel="noopener noreferrer"
              className="underline underline-offset-2 transition-colors hover:text-[var(--sys-blue)]"
              style={{ color: "var(--text-tertiary)" }}
            >
              Cohere Command R+
            </a>
