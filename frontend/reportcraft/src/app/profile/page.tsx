  ...
  if (isLoading || !user) return (
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="flex flex-col items-center gap-6">
        ...
        <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-[var(--rc-accent)]">Verifying Identity...</span>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] py-20 px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[var(--rc-accent)]/10 blur-[120px] rounded-full" />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-24 flex flex-col lg:flex-row lg:items-end justify-between gap-12">
           <div className="flex-1 min-w-0">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--card-bg)] border border-[var(--border)] shadow-sm border border-white/10 text-[10px] font-bold uppercase tracking-widest text-[var(--rc-accent)] mb-8"
              >
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-24">
           {[
             { label: "Analyses", value: stats.reportsCount, icon: FileText, color: "text-[var(--rc-accent)]" },
             ...
             <motion.div 
                ...
                className="card-clean p-8 group hover:scale-[1.02] transition-all"
             >
        ...
        <div className="grid lg:grid-cols-2 gap-8 pb-32">
           <div className="card-clean p-12 border border-white/10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--rc-accent)]/10 blur-3xl -z-10" />
              <h2 className="text-2xl font-bold tracking-tight mb-12 flex items-center gap-3">
                <Cpu size={20} className="text-[var(--rc-accent)]" /> Core Credentials
              </h2>
           ...
           <div className="card-clean p-12 flex flex-col items-center justify-center text-center border border-white/10 relative overflow-hidden group">
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-indigo-500/5 blur-3xl -z-10" />
              <div className="w-16 h-16 rounded-2xl bg-[var(--card-bg)] border border-[var(--border)] shadow-sm mb-8 flex items-center justify-center text-white/20 group-hover:text-indigo-400 transition-colors">
                <Settings size={32} />
              </div>
