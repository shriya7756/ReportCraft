...
from .reportcraft_dataclass import ReportCraftArticle
from ...interface import ArticlePolishingModule
from ...utils import ArticleTextProcessing


class ReportCraftArticlePolishingModule(ArticlePolishingModule):
    """
    ...
    def polish_article(
        self, topic: str, draft_article: ReportCraftArticle, remove_duplicate: bool = False
    ) -> ReportCraftArticle:
        """
        Polish article.
        ...
        Args:
            ...
            draft_article (ReportCraftArticle): The draft article.
