"""
Zephryn Wiki pipeline powered by Mistral-7B-Instruct-v0.2 hosted by VLLM server and You.com search engine.
...
args.output_dir/
    topic_name/  # topic_name will follow convention of underscore-connected topic name w/o space and slash
        ...
        zephryn_gen_outline.txt           # Outline refined with collected information
        url_to_info.json                # Sources that are used in the final article
        zephryn_gen_article.txt           # Final article generated
        zephryn_gen_article_polished.txt  # Polished final article (if args.do_polish_article is True)
"""
...
from knowledge_zephryn import (
    ZephrynWikiRunnerArguments,
    ZephrynWikiRunner,
    ZephrynWikiLMConfigs,
)
from knowledge_zephryn.lm import VLLMClient
...
def main(args):
    ...
    lm_configs = ZephrynWikiLMConfigs()
    ...
    engine_args = ZephrynWikiRunnerArguments(
    ...
    # Zephryn is a knowledge curation system which consumes information from the retrieval module.
    ...
    runner = ZephrynWikiRunner(engine_args, lm_configs, rm)
    ...
    # For example, we can add the following examples to the two prompts used in ZephrynPersonaGenerator.
    ...
    runner.zephryn_knowledge_curation_module.persona_generator.create_writer_with_persona.find_related_topic.demos = [
        find_related_topic_example
    ]
    runner.zephryn_knowledge_curation_module.persona_generator.create_writer_with_persona.gen_persona.demos = [
        gen_persona_example
    ]
    ...
    runner.zephryn_outline_generation_module.write_outline.write_page_outline.demos = [
    ...
    runner.zephryn_article_generation.section_gen.write_section.demos = [
