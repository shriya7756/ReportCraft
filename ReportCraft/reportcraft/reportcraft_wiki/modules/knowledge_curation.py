...
from .persona_generator import ReportCraftPersonaGenerator
from .reportcraft_dataclass import DialogueTurn, ReportCraftInformationTable
...
class ReportCraftKnowledgeCurationModule(KnowledgeCurationModule):
    """
    ...
    def __init__(
        self,
        retriever: Retriever,
        persona_generator: Optional[ReportCraftPersonaGenerator],
    ...
    def research(
    ...
    ) -> Union[ReportCraftInformationTable, Tuple[ReportCraftInformationTable, Dict]]:
        """
        ...
        information_table = ReportCraftInformationTable(conversations)
        callback_handler.on_information_gathering_end()
        if return_conversation_log:
            return information_table, ReportCraftInformationTable.construct_log_dict(
                conversations
            )
