...
export function HeroIllustration() {
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto aspect-square flex items-center justify-center pointer-events-none" aria-hidden="true">
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[var(--rc-accent)]/10 blur-[140px] rounded-full animate-pulse" />
      ...
      <motion.div
        ...
        className="relative w-64 h-64 sm:w-80 sm:h-80 rounded-[40px] bg-[var(--card-bg)] border border-[var(--border)] shadow-sm border border-white/20 shadow-2xl flex items-center justify-center overflow-hidden group"
      >
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--rc-accent)]/10 to-[var(--rc-accent)]/10 opacity-50" />
        ...
        <div className="relative z-10 w-24 h-24 rounded-full bg-white/5 border border-white/20 flex items-center justify-center backdrop-blur-3xl shadow-[0_0_50px_rgba(34,211,238,0.2)] group-hover:shadow-[0_0_80px_rgba(34,211,238,0.4)] transition-all duration-700">
           <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-[var(--rc-accent)]">
      ...
      {[
        ...
        >
          <motion.div
            ...
            className={`w-4 h-4 rounded-lg bg-[var(--card-bg)] border border-[var(--border)] shadow-sm border border-white/20 flex items-center justify-center ${sat.color}/20`}
          >
