                  ...
                  <div className="p-5 flex flex-col sm:flex-row items-center justify-between gap-5">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="p-2.5 rounded-lg bg-[var(--card-bg)] border border-[var(--border)] shadow-sm border border-white/10 hover:border-cyan-500/50 hover:text-[var(--rc-accent)] transition-all"
