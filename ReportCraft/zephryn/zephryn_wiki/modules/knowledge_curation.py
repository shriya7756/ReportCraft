...
from .persona_generator import ZephrynPersonaGenerator
from .zephryn_dataclass import DialogueTurn, ZephrynInformationTable
...
class ZephrynKnowledgeCurationModule(KnowledgeCurationModule):
    """
    ...
    def __init__(
        self,
        retriever: Retriever,
        persona_generator: Optional[ZephrynPersonaGenerator],
    ...
    def research(
    ...
    ) -> Union[ZephrynInformationTable, Tuple[ZephrynInformationTable, Dict]]:
        """
        ...
        information_table = ZephrynInformationTable(conversations)
        callback_handler.on_information_gathering_end()
        if return_conversation_log:
            return information_table, ZephrynInformationTable.construct_log_dict(
                conversations
            )
