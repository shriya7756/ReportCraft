...
class ZephrynArticleGenerationModule(ArticleGenerationModule):
    """
    ...
    def generate_article(
        ...
        article_with_outline: ZephrynArticle,
        ...
        Args:
            ...
            article_with_outline (ZephrynArticle): The article with specified outline.
        ...
        if article_with_outline is None:
            article_with_outline = ZephrynArticle(topic_name=topic)
...
class ConvToSection(dspy.Module):
    ...
    def forward(
        ...
        info = ""
        for idx, zephryn_info in enumerate(collected_info):
            info += f"[{idx + 1}]\n" + "\n".join(zephryn_info.snippets)
            info += "\n\n"
