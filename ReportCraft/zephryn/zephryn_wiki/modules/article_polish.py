...
from .zephryn_dataclass import ZephrynArticle
from ...interface import ArticlePolishingModule
from ...utils import ArticleTextProcessing


class ZephrynArticlePolishingModule(ArticlePolishingModule):
    """
    ...
    def polish_article(
        self, topic: str, draft_article: ZephrynArticle, remove_duplicate: bool = False
    ) -> ZephrynArticle:
        """
        Polish article.
        ...
        Args:
            ...
            draft_article (ZephrynArticle): The draft article.
