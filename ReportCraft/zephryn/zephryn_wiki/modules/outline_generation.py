...
from .zephryn_dataclass import ZephrynInformationTable, ZephrynArticle
from ...interface import OutlineGenerationModule
from ...utils import ArticleTextProcessing


class ZephrynOutlineGenerationModule(OutlineGenerationModule):
    """
    ...
    def generate_outline(
        ...
        old_outline: Optional[ZephrynArticle] = None,
        callback_handler: BaseCallbackHandler = None,
        return_draft_outline=False,
    ) -> Union[ZephrynArticle, Tuple[ZephrynArticle, ZephrynArticle]]:
        """
        ...
        Args:
            ...
            information_table (ZephrynInformationTable): The information table containing the collected information.
            old_outline (Optional[ZephrynArticle]): An optional previous version of the article outline that can
        ...
        Returns:
            Union[ZephrynArticle, Tuple[ZephrynArticle, ZephrynArticle]]: Depending on the value of `return_draft_outline`,
                this method returns either a single `ZephrynArticle` object containing the final outline or a tuple of
                two  `ZephrynArticle` objects, the first containing the final outline and the second containing the
                draft outline.
        """
        ...
        article_with_outline_only = ZephrynArticle.from_outline_str(
            topic=topic, outline_str=result.outline
        )
        article_with_draft_outline_only = ZephrynArticle.from_outline_str(
