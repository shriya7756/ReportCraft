"""
This module handles question generation within the Co-Zephryn framework, specifically designed to support the Moderator role.
...
For more detailed information, refer to Section 3.5 of the Co-Zephryn paper: https://www.arxiv.org/pdf/2408.15232.
"""
...
class GroundedQuestionGenerationModule(dspy.Module):
    ...
    def forward(
        ...
        with dspy.settings.context(lm=self.engine, show_guidelines=False):
            ...
            cited_searched_results = extract_cited_zephryn_info(
                response=utterance, index_to_zephryn_info=index_to_information_mapping
            )
