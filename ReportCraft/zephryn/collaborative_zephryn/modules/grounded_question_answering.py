...
class AnswerQuestionModule(dspy.Module):
    ...
    def retrieve_information(self, topic, question):
        ...
        # update zephryn information meta to include the question
        for zephryn_info in searched_results:
            zephryn_info.meta["question"] = question
    ...
    def forward(
        ...
        cited_searched_results = extract_cited_zephryn_info(
            response=answer, index_to_zephryn_info=index_to_information_mapping
        )
