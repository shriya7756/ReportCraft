...
class ReportCraftArticleGenerationModule(ArticleGenerationModule):
    """
    ...
    def generate_article(
        ...
        article_with_outline: ReportCraftArticle,
        ...
        Args:
            ...
            article_with_outline (ReportCraftArticle): The article with specified outline.
        ...
        if article_with_outline is None:
            article_with_outline = ReportCraftArticle(topic_name=topic)
...
class ConvToSection(dspy.Module):
    ...
    def forward(
        ...
        info = ""
        for idx, reportcraft_info in enumerate(collected_info):
            info += f"[{idx + 1}]\n" + "\n".join(reportcraft_info.snippets)
            info += "\n\n"
