...
from .reportcraft_dataclass import ReportCraftInformationTable, ReportCraftArticle
from ...interface import OutlineGenerationModule
from ...utils import ArticleTextProcessing


class ReportCraftOutlineGenerationModule(OutlineGenerationModule):
    """
    ...
    def generate_outline(
        ...
        old_outline: Optional[ReportCraftArticle] = None,
        callback_handler: BaseCallbackHandler = None,
        return_draft_outline=False,
    ) -> Union[ReportCraftArticle, Tuple[ReportCraftArticle, ReportCraftArticle]]:
        """
        ...
        Args:
            ...
            information_table (ReportCraftInformationTable): The information table containing the collected information.
            old_outline (Optional[ReportCraftArticle]): An optional previous version of the article outline that can
        ...
        Returns:
            Union[ReportCraftArticle, Tuple[ReportCraftArticle, ReportCraftArticle]]: Depending on the value of `return_draft_outline`,
                this method returns either a single `ReportCraftArticle` object containing the final outline or a tuple of
                two  `ReportCraftArticle` objects, the first containing the final outline and the second containing the
                draft outline.
        """
        ...
        article_with_outline_only = ReportCraftArticle.from_outline_str(
            topic=topic, outline_str=result.outline
        )
        article_with_draft_outline_only = ReportCraftArticle.from_outline_str(
