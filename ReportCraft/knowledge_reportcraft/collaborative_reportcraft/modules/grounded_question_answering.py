...
class AnswerQuestionModule(dspy.Module):
    ...
    def retrieve_information(self, topic, question):
        ...
        # update reportcraft information meta to include the question
        for reportcraft_info in searched_results:
            reportcraft_info.meta["question"] = question
    ...
    def forward(
        ...
        cited_searched_results = extract_cited_reportcraft_info(
            response=answer, index_to_reportcraft_info=index_to_information_mapping
        )
