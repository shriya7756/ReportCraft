"""
This module handles question generation within the Co-ReportCraft framework, specifically designed to support the Moderator role.
...
For more detailed information, refer to Section 3.5 of the Co-ReportCraft paper: https://www.arxiv.org/pdf/2408.15232.
"""
...
from .collaborative_reportcraft_utils import (
    ...
    extract_cited_reportcraft_info,
)
...
class GroundedQuestionGenerationModule(dspy.Module):
    ...
    def forward(
        ...
        with dspy.settings.context(lm=self.engine, show_guidelines=False):
            ...
            cited_searched_results = extract_cited_reportcraft_info(
                response=utterance, index_to_reportcraft_info=index_to_information_mapping
            )
