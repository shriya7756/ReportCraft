"""
ReportCraft Wiki pipeline powered by Mistral-7B-Instruct-v0.2 hosted by VLLM server and You.com search engine.
...
args.output_dir/
    topic_name/  # topic_name will follow convention of underscore-connected topic name w/o space and slash
        ...
        reportcraft_gen_outline.txt           # Outline refined with collected information
        url_to_info.json                # Sources that are used in the final article
        reportcraft_gen_article.txt           # Final article generated
        reportcraft_gen_article_polished.txt  # Polished final article (if args.do_polish_article is True)
"""
...
from knowledge_reportcraft.lm import VLLMClient
...
def main(args):
    ...
    engine_args = ReportCraftWikiRunnerArguments(
    ...
    # ReportCraft is a knowledge curation system which consumes information from the retrieval module.
    ...
    # For example, we can add the following examples to the two prompts used in ReportCraftPersonaGenerator.
    ...
    runner.reportcraft_knowledge_curation_module.persona_generator.create_writer_with_persona.find_related_topic.demos = [
        find_related_topic_example
    ]
    runner.reportcraft_knowledge_curation_module.persona_generator.create_writer_with_persona.gen_persona.demos = [
        gen_persona_example
    ]
    ...
    runner.reportcraft_outline_generation_module.write_outline.write_page_outline.demos = [
    ...
    runner.reportcraft_article_generation.section_gen.write_section.demos = [
