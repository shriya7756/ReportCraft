"""
ReportCraft Wiki pipeline powered by local model hosted by Ollama server and You.com or Bing search engine.
...
from knowledge_reportcraft.lm import OllamaClient
