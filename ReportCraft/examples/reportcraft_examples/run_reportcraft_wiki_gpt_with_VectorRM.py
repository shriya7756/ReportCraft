"""
This ReportCraft Wiki pipeline powered by GPT-3.5/4 and local retrieval model that uses Qdrant.
...
from knowledge_reportcraft.rm import VectorRM
from knowledge_reportcraft.lm import OpenAIModel, AzureOpenAIModel
from knowledge_reportcraft.utils import load_api_key, QdrantVectorStoreManager
...
def main(args):
    ...
    engine_lm_configs = ReportCraftWikiLMConfigs()
    openai_kwargs = {
    ...
    # Initialize the ReportCraft Wiki Runner
    runner = ReportCraftWikiRunner(engine_args, engine_lm_configs, rm)
