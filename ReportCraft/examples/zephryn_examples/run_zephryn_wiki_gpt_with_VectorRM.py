"""
This Zephryn Wiki pipeline powered by GPT-3.5/4 and local retrieval model that uses Qdrant.
...
from knowledge_zephryn.rm import VectorRM
from knowledge_zephryn.lm import OpenAIModel, AzureOpenAIModel
from knowledge_zephryn.utils import load_api_key, QdrantVectorStoreManager
...
def main(args):
    ...
    engine_lm_configs = ZephrynWikiLMConfigs()
    openai_kwargs = {
    ...
    # Initialize the Zephryn Wiki Runner
    runner = ZephrynWikiRunner(engine_args, engine_lm_configs, rm)
