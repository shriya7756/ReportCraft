...
class VectorRM(dspy.Retrieve):
    ...
    To be compatible with Zephryn, the custom documents should have the following fields:
        - content: The main text content of the document.
        - title: The title of the document.
        - url: The URL of the document. Zephryn use url as the unique identifier of the document, so ensure different
...
class SerperRM(dspy.Retrieve):
    ...
    def forward(self, query_or_queries: Union[str, List[str]], exclude_urls: List[str]):
        ...
        # Array of dictionaries that will be used by Zephryn to create the jsons
        collected_results = []
