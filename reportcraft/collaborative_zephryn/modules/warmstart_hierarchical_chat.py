"""
Warm starts the Co-Zephryn system by conducting a background information search to establish a shared conceptual space with the user.
 
This stage functions as a mini-Zephryn, where multiple LLM agents are spawned with different perspectives to engage in multi-round conversations. 
...
from .collaborative_zephryn_utils import _get_answer_question_module_instance
...
from ...zephryn_wiki.modules.outline_generation import WritePageOutline
